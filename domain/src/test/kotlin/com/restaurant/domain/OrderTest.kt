...
class OrderTest : BehaviorSpec({
    given("given I have an Order a bunch of stuff") {
        val order = Order(
            ...
            mutableListOf(
                ...
                OrderItem("fish and chips", 2, 8.75),
                OrderItem("spicy mushroom people on corn bread", 5, 11.25),
                OrderItem("chicken wings", 5, 2.75)
            )
        )
    ...
    given("given I have an Order for Fish and Chips @ £8.75 twice") {
        val fishAndChipsOrder = OrderItem("fish and chips", 2, 8.75)
        `when`("I produce a bill") {
